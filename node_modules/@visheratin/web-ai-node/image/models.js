...
exports.models = exports.ListImageModels = void 0;
const modelType_js_1 = require("./modelType.js");
const ListImageModels = (tags, type) => {
    if (!tags && !type) {
        return exports.models;
    }
    return exports.models.filter((model) => {
        let tagCheck = true;
...
exports.models = [
    {
        ...
        description: "",
        memEstimateMB: 100,
        type: modelType_js_1.ModelType.Classification,
        sizeMB: 19,
        modelPaths: new Map([
            [
                "model",
        ...
        configPath: "https://web-ai-models.org/image/classification/mobilevit-small/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/mobilevit-small/preprocessor_config.json",
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/mobilevit-x-small/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/mobilevit-x-small/preprocessor_config.json",
        examples: classificationExamples,
        tags: ["classification", "mobilevit"],
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/mobilevit-xx-small/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/mobilevit-xx-small/preprocessor_config.json",
        examples: classificationExamples,
        tags: ["classification", "mobilevit"],
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/segformer-b2/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/segformer-b2/preprocessor_config.json",
        examples: classificationExamples,
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/segformer-b1/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/segformer-b1/preprocessor_config.json",
        examples: classificationExamples,
        tags: ["classification", "segformer"],
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/segformer-b0/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/segformer-b0/preprocessor_config.json",
        examples: classificationExamples,
        tags: ["classification", "segformer"],
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 120,
        type: modelType_js_1.ModelType.ObjectDetection,
        sizeMB: 24,
        modelPaths: new Map([
            [
                "model",
        ...
        configPath: "https://web-ai-models.org/image/object-detection/yolos/config.json",
        preprocessorPath: "https://web-ai-models.org/image/object-detection/yolos/preprocessor_config.json",
        examples: classificationExamples,
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 50,
        type: modelType_js_1.ModelType.Segmentation,
        sizeMB: 3,
        modelPaths: new Map([
            [
                "model",
        ...
        configPath: "https://web-ai-models.org/image/segmentation/segformer-b0/config.json",
        preprocessorPath: "https://web-ai-models.org/image/segmentation/segformer-b0/preprocessor_config.json",
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/segmentation/segformer-b1/config.json",
        preprocessorPath: "https://web-ai-models.org/image/segmentation/segformer-b1/preprocessor_config.json",
        examples: segmentationExamples,
        tags: ["segmentation", "segformer"],
        referenceURL: "https://huggingface.co/nvidia/segformer-b1-finetuned-ade-512-512",
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/segmentation/segformer-b4/config.json",
        preprocessorPath: "https://web-ai-models.org/image/segmentation/segformer-b4/preprocessor_config.json",
        examples: segmentationExamples,
        tags: ["segmentation", "segformer"],
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 1900,
        type: modelType_js_1.ModelType.Img2Img,
        sizeMB: 4,
        modelPaths: new Map([
            ["model", "https://web-ai-models.org/image/img2img/small/model.onnx.gz"],
        ]),
        preprocessorPath: "https://web-ai-models.org/image/img2img/small/preprocessor_config.json",
    ...
    },
    {
        ...
        preprocessorPath: "https://web-ai-models.org/image/img2img/compressed/preprocessor_config.json",
        examples: superresExamples,
        tags: ["img2img", "superres"],
    ...
    },
    {
        ...
        configPath: "https://web-ai-models.org/image/classification/EfficientFormer/config.json",
        preprocessorPath: "https://web-ai-models.org/image/classification/EfficientFormer/preprocessor_config.json",
        examples: classificationExamples,
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 180,
        type: modelType_js_1.ModelType.FeatureExtraction,
        sizeMB: 43,
        modelPaths: new Map([
            [
                "model",
        ...
        configPath: "https://web-ai-models.org/image/feature-extraction/EfficientFormer/config.json",
        preprocessorPath: "https://web-ai-models.org/image/feature-extraction/EfficientFormer/preprocessor_config.json",
        examples: classificationExamples,
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 2600,
        type: modelType_js_1.ModelType.SegmentAnything,
        sizeMB: 108,
        configPath: "https://web-ai-models.org/image/feature-extraction/EfficientFormer/config.json",
        modelPaths: new Map([
            [
