...
exports.PreprocessorConfig = void 0;
...
exports.PreprocessorConfig = PreprocessorConfig;
_a = PreprocessorConfig;
PreprocessorConfig.fromFile = async (configPath) => {
    const configData = await fetch(configPath).then((resp) => resp.json());
    const config = _a.parseConfig(configData);
    return config;
};
PreprocessorConfig.parseConfig = (configData) => {
...
//# sourceMappingURL=preprocessorConfig.js.map