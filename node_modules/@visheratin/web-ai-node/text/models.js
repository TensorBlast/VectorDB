...
exports.models = exports.ListTextModels = void 0;
const modeType_js_1 = require("./modeType.js");
const ListTextModels = (tags, type) => {
    if (!tags && !type) {
...
exports.ListTextModels = ListTextModels;
exports.models = [
    {
        ...
        description: "",
        memEstimateMB: 450,
        type: modeType_js_1.ModelType.Seq2Seq,
        sizeMB: 113,
        modelPaths: new Map([
            [
                "encoder",
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/grammar-correction/t5-tiny/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
    ...
    },
    {
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/grammar-correction/t5-mini/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
    ...
    },
    {
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/general/flan-t5-small/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
    ...
    },
    {
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/summarization/minhtoanphan/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
    ...
    },
    {
        ...
        description: "",
        memEstimateMB: 1000,
        type: modeType_js_1.ModelType.FeatureExtraction,
        sizeMB: 190,
        modelPaths: new Map([
            [
                "encoder",
        ...
        outputNames: new Map([["encoder", "hidden_states"]]),
    ...
    },
    {
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/summarization/samsum/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
    ...
    },
    {
        ...
        tokenizerPath: "https://web-ai-models.org/text/seq2seq/general/flan-t5-base/tokenizer.json",
        tokenizerParams: {
            bosTokenID: 0,
            eosTokenID: 1,
            padTokenID: 0,
